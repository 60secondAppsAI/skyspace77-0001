						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Availability" type="text" placeholder="Enter Availability" v-model="seatToAdd.availability"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Availability</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Availability" type="text" placeholder="Enter Availability" v-model="seatDetails.availability"></input>
																		</div>
						</td>
														</tr>
