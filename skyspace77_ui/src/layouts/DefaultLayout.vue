...
-->>
				...
				<a-menu-item>
					<router-link to="/itinerarys">
						<span class="label">Itinerarys</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/emergencyContacts">
						<span class="label">Emergency Contacts</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/visas">
						<span class="label">Visas</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/mealPreferences">
