    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'insuranceProvider',
          visible: true,
          scopedSlots: { customRender: 'insuranceProvider' },
          sorter: true
          //sorter: (a, b) => a.insuranceProvider - b.insuranceProvider,
          //sorter: (a, b) => a.insuranceProvider.localeCompare(b.insuranceProvider),
        },
        {
