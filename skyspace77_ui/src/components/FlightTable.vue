    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'departureDateTime',
          visible: true,
          scopedSlots: { customRender: 'departureDateTime' },
          sorter: true
          //sorter: (a, b) => a.departureDateTime - b.departureDateTime,
          //sorter: (a, b) => a.departureDateTime.localeCompare(b.departureDateTime),
        },
        {
		...
		dataIndex: 'arrivalDateTime',
          ...
          sorter: true
          //sorter: (a, b) => a.arrivalDateTime - b.arrivalDateTime,
		...
		dataIndex: 'originAirport',
          visible: true,
          scopedSlots: { customRender: 'originAirport' },
          sorter: true
          //sorter: (a, b) => a.originAirport - b.originAirport,
          //sorter: (a, b) => a.originAirport.localeCompare(b.originAirport),
        },
        {
          title: 'Destination Airport',
		dataIndex: 'destinationAirport',
          visible: true,
          scopedSlots: { customRender: 'destinationAirport' },
          sorter: true
          //sorter: (a, b) => a.destinationAirport - b.destinationAirport,
          //sorter: (a, b) => a.destinationAirport.localeCompare(b.destinationAirport),
        },
      ],
      pagination: {
        current: 1,
